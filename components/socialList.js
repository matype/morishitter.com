  ...
  return (
    <section className={styles.container}>
      <ul className={styles.list}>
        <li>
          <a href="https://twitter.com/morishitter_" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://dribbble.com/vug" target="_blank" rel="noopener noreferrer">
            <div className={`${styles.iconWrapper} ${styles.dribbble}`}>
              <div className={`${styles.icon}`}>
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
